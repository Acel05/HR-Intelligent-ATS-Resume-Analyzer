    ...
    def extract(self, text: str) -> SkillsData:
        ...
        for category, skills_set in self.all_skills.items():
            for skill in skills_set:
                # Perbaikan khusus untuk kata "keras" di bahasa Indonesia
                if skill == 'keras':
                    # Menggunakan negative lookbehind: cocokkan "keras" HANYA jika bukan "kerja keras"
                    pattern = r'(?<!kerja )\bkeras\b'
                else:
